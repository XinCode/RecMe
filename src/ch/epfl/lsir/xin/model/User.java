...
public class User extends AbstractUser {
	 ...
	 * @param: index of this user
	 * */
	public User( String userID , int index )
	{
		super( userID , index );
	...
	/**
	 * this function generates the mean rating of this user (consider all ratings)
	 * @return: mean of all ratings
	 * */
	...
	/**
	 * this function generates the mean rating of this user (consider train ratings)
	 * @return: mean of training ratings
	 * */
